  ...
  <script>
    ...
    export default {
        ...
        fetchPosts() {
            ...
            const searchdetail = this.$route.params.searchdetail; 
            // 发起 GET 请求，获取帖子列表数据
            axios.get(`http://127.0.0.1:8080/api/v1/postswithsearch?index=${searchdetail}&page=${this.page}&size=${this.size}`)
            .then(response => {
